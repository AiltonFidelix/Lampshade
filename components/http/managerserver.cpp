...
// TODO: these are from the brightness, change for manager

extern const uint8_t index_min_html_start[] asm("_binary_brightness_min_html_start");
extern const uint8_t index_min_html_end[] asm("_binary_brightness_min_html_end");

extern const uint8_t app_min_js_start[] asm("_binary_brightness_min_js_start");
extern const uint8_t app_min_js_end[] asm("_binary_brightness_min_js_end");
...
{
    ESP_LOGI(m_tag.c_str(), "brightness.min.js requested");
